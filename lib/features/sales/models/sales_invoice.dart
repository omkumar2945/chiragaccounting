...
class SalesInvoice {
  ...
  final StandardAddress? sellerLocation;
  ...
  SalesInvoice copyWith({
    ...
    String? gstNumber,
    String? panNumber,
    StandardAddress? sellerLocation,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      if (sellerLocation != null) 'sellerLocation': sellerLocation!.toMap(),
  ...
  factory SalesInvoice.fromMap(Map<String, dynamic> map) {
    return SalesInvoice(
      ...
      sellerLocation: map['sellerLocation'] is Map
          ? StandardAddress.fromMap(
              Map<String, dynamic>.from(map['sellerLocation'] as Map),
            )
          : null,
